...
const Card = () => {
  ...
  const renderActiveCard = () => {
    if (activeCard.hasOwnProperty('cardNumber')) {
      return (
        <article className='card card__behind' style={{ background: `${activeCard.cardVendor[1]}`, color: `${activeCard.cardVendor[2]}` }}>
          <aside className='card__icons'>
            <img className='card__chipcolor' src="../../src/assets/chip-dark.svg" alt="" />
            <img className='card__logoimage' src={`../../src/assets/vendor-${activeCard.cardVendor[0]}.svg`} alt="" />
          </aside>
      ...
      return (
        <article className='card card__behind'>
          <aside className='card__icons'>
            <img className='card__chipcolor' src="../../src/assets/chip-dark.svg" alt="" />
            <img className='card__logoimage' src="../../src/assets/vendor-bitcoin.svg" alt="" />
          </aside>
